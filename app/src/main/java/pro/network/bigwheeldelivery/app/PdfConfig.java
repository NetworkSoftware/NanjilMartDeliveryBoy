package pro.network.bigwheeldelivery.app;
...
import pro.network.bigwheeldelivery.order.Order;
...
public class PdfConfig {
    ...
    public static void addContent(Document document, Order myorderBean, Context context) throws Exception {
        ...
        table20.addCell(createTextCell("Address :" + myorderBean.getAddressOrg(), catNormalFont));
        ...
        table21.addCell(createTextCell("Estimate Time :" + myorderBean.getDeliveryTime(), catNormalFont));
        ...
        for (int i = 0; i < myorderBean.getProductBeans().size(); i++) {
            StockList productListBean = myorderBean.getProductBeans().get(i);
            int quan = Integer.parseInt(productListBean.getQty());
            int perQuanPri = (int) Double.parseDouble(productListBean.getPrice());
            ...
            if(i==myorderBean.getProductBeans().size()-1){
                ...
                table3.addCell(createTextCellBottomWithRight(productListBean.getSubcategory() + " " + productListBean.productName, catFont));
                ...
                table3.addCell(createTextCellBottom(productListBean.getSubcategory() + " " + productListBean.productName, catFont));
