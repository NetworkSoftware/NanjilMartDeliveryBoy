...
import pro.network.shopbazaardelivery.service.Service;
...
public class PdfConfig {
    ...
    public static void addContent(Document document, Service mainbean, Context context) throws Exception {
        ...
        table1.addCell(createTextCellCenter("Mobile.com\nPh:90805 83904", nameFont, true));
        ...
        table5.addCell(createTextcenter("FOR EXCHANGE POLICY PLEASE VISIT MOBILE.com", subFont, true));
